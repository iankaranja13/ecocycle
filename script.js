...
//     const botResponses = [
//         "Thanks for asking! EcoCycle helps you earn points by recycling. Every scan at a drop-off point gives you rewards!",
//         "Great question! You can find recycling locations using our app. We partner with schools, malls, and community centers.",
//         "We accept paper, plastic, glass, electronics, and metals. Each location may specialize in different materials.",
//         "Points can be redeemed for gift cards, eco-friendly products, discounts at partner stores, and exclusive experiences!",
//         "Yes! Families can create shared accounts to combine points and work toward bigger rewards together.",
//         "Our app is available for both iOS and Android. You can download it from the App Store or Google Play."
//     ];
